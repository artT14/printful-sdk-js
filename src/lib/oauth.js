...
var OAuthAPI = /** @class */ (function (_super) {
    ...
    function OAuthAPI(headers, origin) {
        return _super.call(this, headers, origin) || this;
    }
    OAuthAPI.prototype.getScopes = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, response, data, _a, result, code, error, scopes;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        url = this.origin + "/oauth/scopes";
                    ...
                    case 3:
                        ...
                        if (code >= 400) {
                            return [2 /*return*/, { scopes: [], error: error }];
                        }
                        return [4 /*yield*/, result];
                    case 4:
                        scopes = (_b.sent()).scopes;
                        return [2 /*return*/, { scopes: scopes, error: {} }];
                }
            });
        });
    };
